...
def difference_checksum(spreadsheet):
    return sum(difference(num_list(item)) for item in spreadsheet)
...
class TestDay2Part1(TestCase):
    ...
    def test_difference(self):
        assert_equal(8, difference(num_list('5 1 9 5')))
...
def division_checksum(spreadsheet):
    return sum(divide_evenly_divisible(num_list(item)) for item in spreadsheet)
...
class TestDay2Part2(TestCase):
    ...
    def test_even_division(self):
        assert_equal(4, divide_evenly_divisible(num_list('5 9 2 8')))
        assert_equal(3, divide_evenly_divisible(num_list('9 4 7 3')))
        assert_equal(2, divide_evenly_divisible(num_list('3 8 6 5')))
